...
class YoloV8Node(Node):
    def __init__(self):
        ...
        self.publisher_label = self.create_publisher(String, 'signal_value', 10)
        self.subscription = self.create_subscription(Image, 'video_source/raw', self.image_callback, 10)
        self.bridge = CvBridge()
        self.model = YOLO(r"/home/puzzlebot/proyecto_final/proyecto_final/modelos/best_semaforo.pt")
